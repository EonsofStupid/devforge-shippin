...
| @ogun/core:1.19.0 | 2.103                 | 0.041          | 1.950  | 0.076        |
...
- `--extensions`: Provide a list of extensions (need to be locally installed) that shall be tested (default: all extensions in packages folder)
  ...
  - _and be separated by whitespaces_
    ...
    _For example: `--extensions @ogun/core:1.19.0 @ogun/keymaps:1.19.0`_
...
| ------------------ | --------------------------------------------- | --------------------- | -------------- | ------ |
| @ogun/foo:1.19.0  | All frontend contributions settled            | 2.015                 | 0.032          | 1.588  |
| @ogun/foo:1.19.0  | Frontend FooFrontendContribution.onStart      | 0.087                 | 0.006          | 6.897  |
| @ogun/foo:1.19.0  | Frontend FooFrontendContribution.initialize   | 0.004                 | 0.001          | 25.000 |
