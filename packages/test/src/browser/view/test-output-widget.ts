...
import { BaseWidget, Message, Widget, codicon, isFirefox } from '@ogun/core/lib/browser';
...
import { TerminalThemeService } from '@ogun/terminal/lib/browser/terminal-theme-service';
