...
@injectable()
export class SettingSurfaceProvider implements WebForgeSurfaceProvider {
...
@injectable()
export class CommandSurfaceProvider implements WebForgeSurfaceProvider {
...
@injectable()
export class ViewSurfaceProvider implements WebForgeSurfaceProvider {
...
@injectable()
export class EditorSurfaceProvider implements WebForgeSurfaceProvider {
...
@injectable()
export class TerminalSurfaceProvider implements WebForgeSurfaceProvider {
 ...
 */
@injectable()
export class InputSurfaceProvider implements WebForgeSurfaceProvider {
