...
/**
 * Ogun direct channels — the Act plane.
 *
 * The backend exposes an HTTP endpoint (`/ogun/channel`) that ANY authorized
...
export const OGUN_CHANNEL_SERVICE_PATH = '/services/ogun-channels';

export const OgunChannelService = Symbol('OgunChannelService');
export const OgunChannelClient = Symbol('OgunChannelClient');

export interface OgunStateSnapshot {
...
export interface OgunChannelClient {
    ...
    getState(): Promise<OgunStateSnapshot>;
    /**
 ...
 */
export interface OgunChannelService {
