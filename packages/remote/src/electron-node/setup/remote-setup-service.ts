...
import { RemoteCliContext, RemoteCliContribution, RemotePlatform } from '@ogun/core/lib/node/remote/remote-cli-contribution';
...
import { ContributionProvider, OS, THEIA_VERSION } from '@ogun/core';
