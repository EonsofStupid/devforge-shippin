...
export const WebForgeCatalogContribution = Symbol('WebForgeCatalogContribution');
 ...
 */
export interface WebForgeCatalogContribution {
 ...
 */
@injectable()
export class WebForgeCatalogHints {

    @inject(ContributionProvider) @named(WebForgeCatalogContribution)
    protected readonly contributions: ContributionProvider<WebForgeCatalogContribution>;
