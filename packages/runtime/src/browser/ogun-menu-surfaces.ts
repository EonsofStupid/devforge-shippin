...
import { SurfaceDescriptor, SurfaceKind, SurfaceQuery } from '../common/ogun-surfaces';
 ...
 */
@injectable()
export class MenuSurfaceProvider implements OgunSurfaceProvider {
 ...
 */
@injectable()
export class ButtonSurfaceProvider implements OgunSurfaceProvider {
...
export const POINTING_CLASS = 'ogun-clyffy-pointing';
