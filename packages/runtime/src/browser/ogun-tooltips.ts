...
import { ApplicationShell, FrontendApplicationContribution, HoverService, Widget } from '@ogun/core/lib/browser';
import { TabBarToolbarRegistry } from '@ogun/core/lib/browser/shell/tab-bar-toolbar';
import { inject, injectable } from '@ogun/core/shared/inversify';
import { OgunCatalogHints } from './ogun-catalog-hints';

/**
 * Mark any element with the address of the surface it represents, and it explains itself.
 *
 *     <button data-ogun-surface="command:ogun.layer.full">…</button>
 */
export const SURFACE_ATTRIBUTE = 'data-ogun-surface';
 ...
 */
@injectable()
export class OgunTooltips implements FrontendApplicationContribution {

    @inject(HoverService)
    protected readonly hovers: HoverService;

    @inject(OgunCatalogHints)
    protected readonly hints: OgunCatalogHints;
