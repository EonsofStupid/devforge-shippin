...
import { DisposableCollection, Disposable, UntitledResourceResolver } from '@ogun/core';
import { MonacoEditorModel } from '@ogun/monaco/lib/browser/monaco-editor-model';
import { RPCProtocol } from '../../common/rpc-protocol';
import { EditorModelService } from './text-editor-model-service';
import { EditorOpenerOptions, EncodingMode } from '@ogun/editor/lib/browser';
import URI from '@ogun/core/lib/common/uri';
import { URI as CodeURI } from '@ogun/core/shared/vscode-uri';
import { ApplicationShell, SaveReason } from '@ogun/core/lib/browser';
