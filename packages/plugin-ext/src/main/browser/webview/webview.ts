...
import { WebviewPanelOptions, WebviewPortMapping } from '@ogun/plugin';
import { BaseWidget, Message, codicon } from '@ogun/core/lib/browser/widgets/widget';
...
import { OutputChannelManager } from '@ogun/output/lib/browser/output-channel';
import { WebviewResourceCache } from './webview-resource-cache';
import { Endpoint } from '@ogun/core/lib/browser/endpoint';
import { isFirefox } from '@ogun/core/lib/browser/browser';
import { FileService } from '@ogun/filesystem/lib/browser/file-service';
import { FileOperationError, FileOperationResult } from '@ogun/filesystem/lib/common/files';
import { BinaryBufferReadableStream } from '@ogun/core/lib/common/buffer';
import { ExtractableWidget } from '@ogun/core/lib/browser/widgets/extractable-widget';
import { MenuPath, ILogger } from '@ogun/core';
