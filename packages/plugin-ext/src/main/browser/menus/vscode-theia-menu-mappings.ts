...
import { CommonMenus, SHELL_TABBAR_CONTEXT_MENU } from '@ogun/core/lib/browser';
import { Navigatable } from '@ogun/core/lib/browser/navigatable';
import { URI as CodeUri } from '@ogun/core/shared/vscode-uri';
import { DebugStackFramesWidget } from '@ogun/debug/lib/browser/view/debug-stack-frames-widget';
import { DebugThreadsWidget } from '@ogun/debug/lib/browser/view/debug-threads-widget';
import { DebugToolBar } from '@ogun/debug/lib/browser/view/debug-toolbar-widget';
import { DebugVariablesWidget } from '@ogun/debug/lib/browser/view/debug-variables-widget';
import { EditorWidget, EDITOR_CONTEXT_MENU, EDITOR_CONTENT_MENU } from '@ogun/editor/lib/browser';
import { NAVIGATOR_CONTEXT_MENU } from '@ogun/navigator/lib/browser/navigator-contribution';
import { ScmTreeWidget } from '@ogun/scm/lib/browser/scm-tree-widget';
import { PLUGIN_SCM_CHANGE_TITLE_MENU } from '@ogun/scm/lib/browser/dirty-diff/dirty-diff-widget';
import {
    SCM_REPOSITORY_MENU, SCM_SOURCE_CONTROL_MENU, SCM_SOURCE_CONTROL_TITLE_MENU, SCM_TITLE_MENU
} from '@ogun/scm/lib/browser/scm-repositories-widget';
import {
    SCM_HISTORY_TITLE_MENU, SCM_HISTORY_ITEM_CONTEXT_MENU, SCM_HISTORY_ITEM_REF_CONTEXT_MENU
} from '@ogun/scm/lib/browser/scm-history-graph-widget';
import { TIMELINE_ITEM_CONTEXT_MENU } from '@ogun/timeline/lib/browser/timeline-tree-widget';
...
import { EDITOR_LINENUMBER_CONTEXT_MENU } from '@ogun/editor/lib/browser/editor-linenumber-contribution';
import { PLUGIN_TEST_VIEW_TITLE_MENU, TEST_VIEW_CONTEXT_MENU } from '@ogun/test/lib/browser/view/test-view-contribution';
import { TEST_RUNS_CONTEXT_MENU } from '@ogun/test/lib/browser/view/test-run-view-contribution';
...
/** @deprecated Use SCM_TITLE_MENU from @ogun/scm/lib/browser/scm-repositories-widget */
