...
export class PluginWorker {
    ...
    constructor() {
        // Note: The worker script is generated by the bundler as "plugin-worker.js" in the frontend output directory
        // The entry point for this worker is in ./worker/worker-main.ts
        this.worker = new Worker(new URL('./plugin-worker.js', location.href));
