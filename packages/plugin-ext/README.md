...
The `@ogun/plugin-ext` extension contributes functionality for the `plugin` API.
...
- [API documentation for `@ogun/plugin-ext`](https://eclipse-theia.github.io/theia/docs/next/modules/_theia_plugin-ext.html)
