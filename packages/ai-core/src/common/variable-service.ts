...
import { ContributionProvider, Disposable, Emitter, ILogger, MaybePromise, Prioritizeable, Event } from '@ogun/core';
...
export class DefaultAIVariableService implements AIVariableService {
    ...
    @inject(ILogger) @named('ai-core:DefaultAIVariableService')
