...
import { CommandService, nls, PreferenceService } from '@ogun/core';
...
import { AICorePreferences, PREFERENCE_NAME_MAX_RETRIES } from '@ogun/ai-core/lib/common/ai-core-preferences';
