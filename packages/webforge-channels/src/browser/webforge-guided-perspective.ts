...
import { PerspectiveChromeOptions, PerspectiveContribution, PerspectiveService } from '@theia/core/lib/browser/perspective-service';
import { ChatViewWidget } from '@theia/ai-chat-ui/lib/browser/chat-view-widget';
import { EXPLORER_VIEW_CONTAINER_ID } from '@theia/navigator/lib/browser';

export const WEBFORGE_GUIDED_PERSPECTIVE_ID = 'webforge.guided';

/**
 * The Guided perspective: WebForge arranged for someone who has never opened an IDE.
 *
 ...
 */
@injectable()
export class WebForgeGuidedPerspectiveContribution implements PerspectiveContribution {
    ...
    registerPerspectives(service: PerspectiveService): void {
        ...
        service.registerPerspective({
            id: WEBFORGE_GUIDED_PERSPECTIVE_ID,
            label: nls.localize('webforge/perspective/guided', 'Guided'),
